...
Vulpix is an extensible utility script that helps to setup your development environment, as well as providing some command line utilities to ease your development.
...
- Event listeners to invoke commands or functions after a command is invoked in the 